...
export class BreadcrumbService {
  private routesFriendlyNames = new Map<string, string>();
  private routesFriendlyNamesRegex = new Map<string, string>();
  private routesWithCallback = new Map<string, (string) => string>();
  private routesWithCallbackRegex = new Map<string, (string) => string>();

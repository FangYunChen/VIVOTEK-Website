...
import { SmartMotionDetectionModelTypeRoutingModule } from './smart-motion-detection-model-type-routing.module';
...
@NgModule({
  imports: [
    ...
    SmartMotionDetectionModelTypeRoutingModule
  ],
  declarations: [
...
export class SmartMotionDetectionModelTypeModule { }

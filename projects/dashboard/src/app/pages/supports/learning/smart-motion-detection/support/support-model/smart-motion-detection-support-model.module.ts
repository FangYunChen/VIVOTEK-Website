...
import { SmartMotionDetectionSupportModelRoutingModule } from './smart-motion-detection-support-model-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    FlexLayoutModule,
    SmartMotionDetectionSupportModelRoutingModule,
    SharedModule,
...
export class SmartMotionDetectionSupportModelModule { }

import { SmartTrackingAdvancedModelTypeRoutingModule } from './smart-tracking-advanced-model-type-routing.module';
...
@NgModule({
  imports: [
    ...
    SmartTrackingAdvancedModelTypeRoutingModule
  ],
  declarations: [
...
export class SmartTrackingAdvancedModelTypeModule { }

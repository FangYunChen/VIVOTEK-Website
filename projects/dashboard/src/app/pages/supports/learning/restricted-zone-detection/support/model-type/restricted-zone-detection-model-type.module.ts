import { RestrictedZoneDetectionModelTypeRoutingModule } from './restricted-zone-detection-model-type-routing.module';
...
@NgModule({
  imports: [
    ...
    RestrictedZoneDetectionModelTypeRoutingModule
  ],
  declarations: [
...
export class RestrictedZoneDetectionModelTypeModule { }

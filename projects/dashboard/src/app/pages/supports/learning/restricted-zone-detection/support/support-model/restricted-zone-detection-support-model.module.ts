...
import { RestrictedZoneDetectionSupportModelRoutingModule } from './restricted-zone-detection-support-model-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    FlexLayoutModule,
    RestrictedZoneDetectionSupportModelRoutingModule,
    SharedModule,
...
export class RestrictedZoneDetectionSupportModelModule { }

...
@Component({
  selector: 'vvtk-smart-vca-list',
  templateUrl: './smart-vca-list.component.html',
  styleUrls: ['./smart-vca-list.component.scss']
})
export class SmartVcaListComponent implements OnInit, OnDestroy {
  ...
  patchSequence() {
    ...
    this.vvtkService.patch(
      {
        path: `api/SmartVca/DisplayOrder`,
        disableLanguage: true
      },
      sequenceData,
      {

...
import { CampaignParticipantsComponent } from './../campaign-participants/campaign-participants.component';
...
export class CampaignsListComponent implements OnInit, OnDestroy {
  ...
  showParticipants(id: number, title: string) {
    const dialogRef = this.dialog.open(CampaignParticipantsComponent, {
      disableClose: false,
      data: {
        id: id,
        title: title

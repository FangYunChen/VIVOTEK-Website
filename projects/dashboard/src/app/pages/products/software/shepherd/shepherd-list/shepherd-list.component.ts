...
@Component({
  selector: 'vvtk-shepherd-list',
  templateUrl: './shepherd-list.component.html',
  styleUrls: ['./shepherd-list.component.scss']
})
export class ShepherdListComponent implements OnInit, OnDestroy {
  ...
  getData() {
    ...
    this.vvtkService.get(
      {
        path: `api/ProductsShepherd/ManageList`
      },
      {
        next: resp => {
  ...
  patchSequence() {
    ...
    this.vvtkService.patch(
      {
        path: `api/ProductsShepherd/DisplayOrder`,
        disableLanguage: true
      },
      sequenceData,
      {

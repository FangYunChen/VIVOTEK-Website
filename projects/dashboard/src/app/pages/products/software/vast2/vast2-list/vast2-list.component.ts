...
@Component({
  selector: 'vvtk-vast2-list',
  templateUrl: './vast2-list.component.html',
  styleUrls: ['./vast2-list.component.scss']
})
export class Vast2ListComponent implements OnInit, OnDestroy {
  ...
  getData() {
    ...
    this.vvtkService.get(
      {
        path: `api/Products/Vast2/ManageList`
      },
      {
        next: resp => {
  ...
  patchSequence() {
    ...
    this.vvtkService.patch(
      {
        path: `api/Products/Vast2/DisplayOrder`,
        disableLanguage: true
      },
      sequenceData,
      {

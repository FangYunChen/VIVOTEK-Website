...
@Component({
  selector: 'vvtk-review-user-permission-counting-camara-content',
  templateUrl: './review-user-permission-counting-camara-content.component.html'
})
export class ReviewUserPermissionCountingCamaraContentComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<ReviewUserPermissionCountingCamaraContentComponent, DownloadCenterApplication[]>,

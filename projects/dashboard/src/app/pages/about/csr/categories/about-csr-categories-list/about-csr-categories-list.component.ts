...
@Component({
  selector: 'vvtk-about-csr-categories-list',
  templateUrl: './about-csr-categories-list.component.html',
  styleUrls: ['./about-csr-categories-list.component.scss']
})
export class AboutCSRCategoriesListComponent implements OnInit, OnDestroy {
  ...
  patchSequence() {
    this.isLoading = true;
    const sequenceData: AboutCSRCategory[] = [];
    let sequence = 1;
    ...
    this.vvtkService.patch(
      {
        path: `api/CSR/Categories/DisplayOrder`,
        disableLanguage: true
      },
      sequenceData,
      {

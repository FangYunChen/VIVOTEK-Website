...
@Component({
  selector: 'vvtk-templates-type3',
  templateUrl: './templates-type3.component.html',
  styleUrls: ['./templates-type3.component.scss']
})
export class TemplatesType3Component implements OnInit {

...
@Component({
  selector: 'vvtk-templates-type6',
  templateUrl: './templates-type6.component.html',
  styleUrls: ['./templates-type6.component.scss']
})
export class TemplatesType6Component implements OnInit {

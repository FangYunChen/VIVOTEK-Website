...
@Component({
  ...
  templateUrl: './restricted-zone-detection.component.html',
  styleUrls: ['./restricted-zone-detection.component.scss']
})
export class RestrictedZoneDetectionComponent implements OnInit {

...
@Component({
  ...
  templateUrl: './smart-tracking-advanced.component.html',
  styleUrls: ['./smart-tracking-advanced.component.scss']
})
export class SmartTrackingAdvancedComponent implements OnInit {

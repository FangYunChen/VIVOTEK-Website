...
@Component({
  selector: 'vvtk-mutiple-banner',
  templateUrl: './mutiple-banner.component.html',
  styleUrls: ['./mutiple-banner.component.scss']
})
export class MutipleBannerComponent implements OnInit {
  @Input() bannerItem;

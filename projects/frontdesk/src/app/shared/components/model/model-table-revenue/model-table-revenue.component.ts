...
@Component({
  selector: 'vvtk-model-table-revenue',
  templateUrl: './model-table-revenue.component.html',
  styleUrls: ['./model-table-revenue.component.scss']
})
export class ModelTableRevenueComponent implements OnInit, OnChanges {
...
　　} 
  ...
  addHref(url){
    if(this.stringisnull(url).toString() != '')
    {
      return true;
    }
    return false;
